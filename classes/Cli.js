...
class Cli {
    ...
    createCar() {
        inquirer
            ...
            .then((answers) => {
            const car = new Car(Vehicle.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(), new Wheel(), new Wheel(), new Wheel()]);
    ...
    createTruck() {
        inquirer
            ...
            .then((answers) => {
            const truck = new Truck(Vehicle.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(20, 'DefaultBrand'), new Wheel(20, 'DefaultBrand'), new Wheel(20, 'DefaultBrand'), new Wheel(20, 'DefaultBrand')], parseInt(answers.towingCapacity));
    ...
    createMotorbike() {
        inquirer
            ...
            .then((answers) => {
            const motorbike = new Motorbike(Vehicle.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(17, 'DefaultBrand'), new Wheel(17, 'DefaultBrand')]);
